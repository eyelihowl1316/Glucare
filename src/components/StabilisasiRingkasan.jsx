...
export default function StabilisasiRingkasan() {
        ...
        <div>
            ...
            <div className="flex gap-4 items-start">
                ...
                <p className="text-[#374151] mt-2 text-sm">
                    Fase pertama berfokus pada memutus siklus resistensi insulin
                    kronis. Dengan konsistensi selama 30 hari, sensitivitas insulin
                    mulai meningkat 15–20% (Diabates Care. 2021).
                </p>
                </div>
            </div>
            </div>
