...
import KonsolidasiRingkasan from "../components/KonsolidasiRingkasan";
import KonsolidasiMingguan from "../components/KonsolidasiMingguan";
import KonsolidasiTargetAkhir from"../components/KonsolidasiTargetAkhir";
        ...
        <div className="flex">
            ...
            <div className={`flex-1 transition-all duration-300 ${isOpen ? 'lg:ml-60' : 'lg:ml-24'}`}>
                ...
                <div className="p-8 max-w-6xl">
                    ...
                    {activeTab === "ringkasan" && <KonsolidasiRingkasan />}
                    {activeTab === "mingguan" && <KonsolidasiMingguan />}
                    {activeTab === "target akhir" && <KonsolidasiTargetAkhir />}
                </div>
            </div>
        </div>
    );
