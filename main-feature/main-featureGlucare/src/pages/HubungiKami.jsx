...
export default function HubungiKami() {
    ...
    return (
        ...
        <section>
            <div className="h-[320px] pt-28 flex flex-col justify-center items-center text-white text-center bg-cover bg-center"
                style={{ backgroundImage: `url(${contactBg})` }}>

                <h1 className="text-4xl font-bold relative after:content-[''] after:block after:w-[100px] after:h-[2px] after:bg-white after:mx-auto after:mt-[20px]">
                    Hubungi Kami
                </h1>

                <p className="mt-[10px] mb-[80px]">
                ...
                <div className="bg-white w-[40%] mx-auto mt-[-80px] mb-20 p-10 rounded-[15px] shadow-lg">
                    <h2 className="text-center text-[#0072CE] text-2xl font-bold mb-[30px]">
                        Kirimkan Kami Pesan
                    </h2>
                ...
                {popup.show && (
                    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
                            <div className="bg-white px-10 py-8 rounded-[15px] text-center animate-in fade-in zoom-in duration-300">
