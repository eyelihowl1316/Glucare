...
export default function FiturUtama() {
    ...
    return (
        ...
        <section className="px-[100px] mt-24 py-10 text-center">
            <h2 className="mb-[50px] text-3xl font-bold">
            ...
            <div
                key={index}
                className={`flex items-center justify-between gap-[50px] mb-20 ${
                fitur.reverse ? "flex-row-reverse" : ""
                }`}>
                    <div className="w-1/2 text-left">
                        <h3 className="text-2xl font-semibold mb-4">{fitur.title}</h3>
                        <p className="text-base text-[#555] leading-relaxed">
                            {fitur.description}
                        </p>
                    </div>

                    <img src={fitur.image} alt={fitur.title} className="w-[300px] rounded-[15px]"/>
                </div>
            ))}
        </section>
